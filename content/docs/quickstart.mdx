...
**Platforms & Edge:**
- [Supabase (Managed Agent)](/docs/platforms/supabase) · [Vercel](/docs/platforms/vercel) · [Cloudflare Workers](/docs/integrations/cloudflare) · [Railway](/docs/platforms/railway)
...
Common combinations:
- **React + Supabase** → Browser SDK + [Supabase Managed Agent](/docs/platforms/supabase)
