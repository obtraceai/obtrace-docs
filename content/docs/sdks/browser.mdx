...
| `VITE_OBTRACE_INGEST_BASE_URL` | Yes | - | Obtrace ingest endpoint URL |
| `VITE_OBTRACE_SERVICE_NAME` | No | `"web-app"` | Identifies this frontend in the Obtrace UI |
| `VITE_OBTRACE_APP_ID` | No | - | Application identifier within a project |
