...
description: Fluxo completo de triagem, do sintoma até hipótese de causa raiz e caminho de remediation.
intent: workflow
llm_priority: high
sourceOfTruth: true
---
...
## Passo 5: Separe mitigação de remediation

Mitigacao temporária pode ser restart, scale, aumento de memória ou rollback. Remediation real responde o que mudou, por que falhou agora e qual alteração impede recorrência.

## Passo 6: Prepare remediation

- [Como a IA decide abrir um PR](/pt-BR/docs/concepts/how-ai-decides-to-open-a-pr)
- [Habilite remediation PRs com segurança](/pt-BR/docs/workflows/enable-remediation-prs-safely)

## Definição de pronto

- A causa raiz provável está explícita
- O gatilho de release ou configuração foi identificado
- A próxima ação de remediation está clara
