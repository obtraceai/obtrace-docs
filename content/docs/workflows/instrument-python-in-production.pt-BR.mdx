...
description: Fluxo opinativo para publicar Obtrace em FastAPI, Django e serviços com workers.
intent: workflow
sourceOfTruth: true
---
...
Use este fluxo quando o primeiro alvo sério de rollout for um serviço Python.
