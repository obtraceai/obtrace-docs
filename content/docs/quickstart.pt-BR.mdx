---
title: Início Rápido
description: Instale um SDK, conecte um ambiente, valide a ingestão e prepare o Obtrace para fluxos de remediation.
category: quickstart
intent: setup
llm_priority: high
sourceOfTruth: true
...
- Contexto suficiente para análise de causa raiz e decisão de remediation.
