...
- [Início Rápido do Obtrace Zero](/pt-BR/docs/obtrace-zero/quickstart)
- [Como funciona](/pt-BR/docs/obtrace-zero/how-it-works)
- [Agentes por Linguagem](/pt-BR/docs/obtrace-zero/language-agents) — detalhamento por linguagem do que é capturado automaticamente
- [Estratégias de Instrumentação](/pt-BR/docs/obtrace-zero/strategies)
...
- [Database Agent](/pt-BR/docs/sdks/db-agent) — coleta métricas de banco de dados de PostgreSQL, MySQL, MongoDB, Redis e mais sem alteração de código
