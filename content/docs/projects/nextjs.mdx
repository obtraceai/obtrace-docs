...
Import the auto entry point in your root layout. Set `NEXT_PUBLIC_OBTRACE_API_KEY` and `NEXT_PUBLIC_OBTRACE_INGEST_BASE_URL` in your environment.
...
NEXT_PUBLIC_OBTRACE_INGEST_BASE_URL=https://ingest.obtrace.ai
